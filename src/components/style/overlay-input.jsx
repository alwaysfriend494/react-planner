...
export default class OverlayInput extends Component {
  ...
  render() {
    ...
    if (this.state.focus) numericInputStyle.border = `2px solid ${SharedStyle.SECONDARY_COLOR.main}`;
